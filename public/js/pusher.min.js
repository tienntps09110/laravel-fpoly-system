...
!(function(t, e) {
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			? define([], e)
			: 'object' == typeof exports ? (exports.Pusher = e()) : (t.Pusher = e());
})(window, function() {
	return (function(t) {
		var e = {};
		function n(o) {
					...
					(t.prototype.decode = function(t) {
						...
						if (
							...
							i < n - 2 &&
								...
								(s |= 256 & u)),
							i < n - 3 &&
								((h = this._decodeChar(t.charCodeAt(i + 3))), (o[r++] = (u << 6) | h), (s |= 256 & h)),
							0 !== s)
						)
		...
		function(t, e, n) {
				...
				y = function(t) {
					...
					return e < 128
						...
						: e < 2048
							...
							: u(224 | ((e >>> 12) & 15)) + u(128 | ((e >>> 6) & 63)) + u(128 | (63 & e));
				},
				g = function(t) {
			...
			function O() {
				for (var t = [ 'Pusher' ], e = 0; e < arguments.length; e++)
					'string' == typeof arguments[e] ? t.push(arguments[e]) : t.push(H(arguments[e]));
				return t.join(' : ');
			}
			function E(t, e) {
			...
			var q = new ((function() {
				...
				z = function(t) {
					var e,
						n = B.urls[t];
					return n
						? (n.fullUrl ? (e = n.fullUrl) : n.path && (e = B.baseUrl + n.path), e ? 'See: ' + e : '')
						: '';
				},
				U = function(t, e, n) {
					var o,
						r = this;
					for (var i in ((o = we.createXHR()).open('POST', r.options.authEndpoint, !0),
				...
				F = function(t, e, n) {
					void 0 !== this.authOptions.headers &&
						q.warn('To send headers with the auth request, you must use AJAX, rather than JSONP.');
					...
					i.src =
						this.options.authEndpoint + '?callback=' + encodeURIComponent(s) + '&' + this.composeQuery(e);
			...
			function Q(t, e) {
				return (
					'/app/' + t + ('?protocol=' + i.PROTOCOL + '&client=js&version=' + i.VERSION + (e ? '&' + e : ''))
				);
			}
			var V = {
			...
			var tt = (function() {
				...
				nt = (function(t) {
					...
					return (
						...
						(e.prototype.connect = function() {
							...
							return (
								this.bindListeners(),
								q.debug('Connecting', { transport: this.name, url: e }),
				...
				ut = { ws: rt, xhr_streaming: new ot(P({}, st, at)), xhr_polling: new ot(P({}, ct, at)) },
				ht = new ot({
					file: 'sockjs',
					urls: $,
			...
			var dt = ut,
				...
				vt = (function() {
					...
					return (
						(t.prototype.createConnection = function(t, e, n, o) {
							var r = this;
							o = P({}, o, { activityTimeout: this.pingDelay });
							var i = this.transport.createConnection(t, e, n, o),
								...
								a = function(t) {
									if ((i.unbind('closed', a), 1002 === t.code || 1003 === t.code))
										r.manager.reportDeath();
									else if (!t.wasClean && s) {
										var e = T.now() - s;
										e < 2 * r.maxPingDelay &&
											(r.manager.reportDeath(), (r.pingDelay = Math.max(e / 2, r.minPingDelay)));
									}
								};
				...
				bt = {
					...
					getCloseAction: function(t) {
						return t.code < 4e3
							? t.code >= 1002 && t.code <= 1004 ? 'backoff' : null
							: 4e3 === t.code
								? 'tls_only'
								: t.code < 4100
									? 'refused'
									: t.code < 4200 ? 'backoff' : t.code < 4300 ? 'retry' : 'refused';
					},
				...
				_t = (function(t) {
					function e(e, n) {
						...
						return (
							(o.id = e), (o.transport = n), (o.activityTimeout = n.activityTimeout), o.bindListeners(), o
						);
					}
					return (
						wt(e, t),
				...
				St = (function() {
					...
					return (
						...
						(t.prototype.finish = function(t, e) {
							this.callback(P({ transport: this.transport, action: t }, e));
						}),
						t
					);
				})(),
					...
					return (
						...
						(e.prototype.trigger = function(t, e) {
							if (0 !== t.indexOf('client-'))
								throw new Pt("Event '" + t + "' does not start with 'client-'");
							if (!this.subscribed) {
						...
						(e.prototype.subscribe = function() {
							...
							this.subscribed ||
								...
								this.authorize(this.pusher.connection.socket_id, function(e, n) {
									e
										? (q.error(n), t.emit('pusher:subscription_error', n))
										: ((n = n),
					...
					return (
						...
						(e.prototype.handleEncryptedEvent = function(t, e) {
							...
							if (this.key)
										...
										if (r.length < this.nacl.secretbox.nonceLength)
											...
											if (null === i)
												return (
													...
													void this.authorize(this.pusher.connection.socket_id, function(
														e,
														s
													) {
														e
															...
															: null !== (i = n.nacl.secretbox.open(o, r, n.key))
																? n.emitJSON(t, Object(Bt.decode)(i))
																: q.error(
								...
								q.debug('Received encrypted event before key has been retrieved from the authEndpoint');
						}),
							...
							var t = this,
								e = function(n, o) {
									n
										...
										: 'error' === o.action
											? (t.emit('error', { type: 'HandshakeError', error: o.error }),
						...
						(e.prototype.resetActivityCheck = function() {
							...
							this.stopActivityCheck(),
								this.connection &&
									...
									(this.activityTimer = new k(this.activityTimeout, function() {
										t.sendActivityCheck();
									}));
						}),
								...
								this.channels[t] ||
									(this.channels[t] = (function(t, e) {
										...
										return 0 === t.indexOf('private-')
											? Gt.createPrivateChannel(t, e)
											: 0 === t.indexOf('presence-')
												? Gt.createPresenceChannel(t, e)
												: Gt.createChannel(t, e);
									})(t, e)),
								this.channels[t]
							);
						}),
								...
								c = function(a, u) {
									u
										...
										: ((r += 1),
											n.loop && (r %= o.length),
											r < o.length
												? (i && ((i *= 2), n.timeoutLimit && (i = Math.min(i, n.timeoutLimit))),
													(s = n.tryStrategy(o[r], t, { timeout: i, failFast: n.failFast }, c)))
												: e(!0));
								};
							return (
				...
				return (
					...
					(t.prototype.connect = function(t, e) {
						...
						if (o && o.timestamp + this.ttl >= T.now()) {
							...
							i &&
								(this.timeline.info({ cached: !0, transport: o.transport, latency: o.latency }),
								r.push(new Vt([ i ], { timeout: 2 * o.latency + 1e3, failFast: !0 })));
						}
						var s = T.now(),
							c = r.pop().connect(t, function o(i, a) {
								i
									? (te(n), r.length > 0 ? ((s = T.now()), (c = r.pop().connect(t, o))) : e(i))
									: (!(function(t, e, n) {
											var o = we.getLocalStorage();
											if (o)
												try {
													o[Zt(t)] = H({ timestamp: T.now(), transport: e, latency: n });
												} catch (t) {}
										})(n, a.transport.name, T.now() - s),
										e(null, a));
							});
						return {
							abort: function() {
			...
			var ie,
				se = function(t, e, n) {
					...
					var i,
						...
						h = new Qt({ lives: 2, minPingDelay: 1e4, maxPingDelay: t.activityTimeout }),
						p = new Qt({ lives: 2, minPingDelay: 1e4, maxPingDelay: t.activityTimeout }),
						l = r('ws', 'ws', 3, s, h),
						f = r('wss', 'ws', 3, c, h),
						...
						C = new Vt([ new ne(re(S), new Yt([ S, new ee(k, { delay: 4e3 }) ]), k) ], u),
						T = new ne(re(C), C, _);
					return (
						(i = e.useTLS
							? new Yt([ m, new ee(T, { delay: 2e3 }) ])
							: new Yt([ m, new ee(w, { delay: 2e3 }), new ee(T, { delay: 5e3 }) ])),
						new Kt(new oe(new ne(re(l), i, T)), o, { ttl: 18e5, timeline: e.timeline, useTLS: e.useTLS })
					);
				},
				ce = {
					...
					return (
						...
						(t.prototype.onOpen = function(t) {
							...
							this.readyState === he.CONNECTING
								? (t &&
										t.hostname &&
										(this.location.base = ((e = this.location.base),
										(n = t.hostname),
										(o = /(https?:\/\/)([^\/:]+)((\/|:)?.*)/.exec(e))[1] + n + o[3])),
						...
						(t.prototype.openStream = function() {
							...
							(this.stream = we.createSocketRequest(
								'POST',
								le(this.hooks.getReceiveURL(this.location, this.session))
							)),
					...
					return (
						(t.prototype.log = function(t, e) {
							t <= this.options.level &&
								(this.events.push(P({}, e, { timestamp: T.now() })),
					...
					return (
						!(
							...
							? ((r = Object.assign({ ignoreNullOrigin: t.ignoreNullOrigin }, r)),
								(s = new ke(e, o, i ? i.getAssistant(c) : c, r)))
							: (s = Oe),
						s
					);
				},
			...
			var je = (function() {
					function t(e, n) {
						...
						'disableStats' in n && q.warn('The disableStats option is deprecated in favor of enableStats'),
							...
							this.config.enableStats &&
								(this.timelineSender = Gt.createTimelineSender(this.timeline, {
					...
					return (
						...
						(t.getClientFeatures = function() {
							return x(
								I({ ws: we.Transports.ws }, function(t) {
									return t.isSupported({});
								})
							);
						}),
